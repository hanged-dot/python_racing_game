...
class PathGenerator:
    ...
    def __is_eligible_point__(self, v):
        if self.__parent__[v] != -1:
            ...
            while t != -1:
                if self.__dist_point_segment__(self.__points__[v], self.__points__[p], self.__points__[
            ...
            while self.__parent__[t] != -1:
                if self.__dist_point_segment__(self.__points__[t], self.__points__[self.__parent__[t]], self.__points__[
